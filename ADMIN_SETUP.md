...
- `ADMIN_EMAILS`: `info@lnh-universe.com`
...
Cloudflare Zero Trust > Access > Applications에서 self-hosted application을 만들고 아래 경로를 보호합니다.

- `www.lnh-universe.com/admin/*`
- `www.lnh-universe.com/api/admin/*`

Allow 정책에는 `info@lnh-universe.com`만 넣습니다. API도 반드시 같은 정책으로 보호해야 합니다.
